...
AlertDialog getLegal(context, nextAction,authController)
{
    AlertDialog legalDialog =  AlertDialog(
       ...
       content:const SingleChildScrollView(
        ...
        child:  Text('''At SPOT, we are committed to protecting the privacy and security of our users. This privacy policy describes how we collect, use, and disclose personal information in connection with your use of the SPOT service.
